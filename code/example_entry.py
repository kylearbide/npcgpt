"""
This explains the dataset format that is used for model training, taken from https://github.com/huggingface/transfer-learning-conv-ai/blob/d4c760731e8f062abd3d61ccdc8fa29ccb5e3485/example_entry.py
The explanation is as follows:
    ...
    utterances: list of dictionaries, each of which has two keys which are lists of strings.
        ...
        history: [dialog_turn_0, ... dialog_turn N], where N is an even number or 0 since the other AI starts every conversation.
    Preprocessing:
...
EXAMPLE_ENTRY = {
    ...
    "utterances": [
        ...
        {"candidates": ["hello i am doing well how are you ?",
         ...
         "history": [
            "hi there . how are you today ?",
            "i am doing well thanks . tell me what you think of the weather ."]
         },
        {"candidates": ["yes they do but i say no to them lol",
                        ...
                        "time of year ?"
                        "that's ok , everything is still great !"],
         "history": [
             "hi there . how are you today ?",
            "i am doing well thanks . tell me what you think of the weather .",
